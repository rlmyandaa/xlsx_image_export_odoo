...
class ResConfigSettings(models.TransientModel):
    ...
    enable_xlsx_image_export = fields.Boolean(string='Enable XLSX Image Export')
    cell_max_height_px = fields.Float(string='Max Height for Image in Cell', default=150)
    cell_image_spacing_percent = fields.Float(string='Spacing in percent for Image in Cell (in Percent)', default=10)
    ...
    def get_values(self):
       ...
       enable_xlsx_image_export = ir_config_param.get_param('xlsx_image_export.enable_xlsx_image_export')
       cell_max_height_px = float(ir_config_param.get_param('xlsx_image_export.cell_max_height_px'))
       cell_image_spacing_percent = float(ir_config_param.get_param('xlsx_image_export.cell_image_spacing_percent'))
       res.update(
